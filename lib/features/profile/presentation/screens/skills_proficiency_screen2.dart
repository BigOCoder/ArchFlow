        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const StepHeader(
                currentStep: 2,
                title: 'Current Skills & Proficiency',
              ),
              ...
              Text(
                'Tell us about your technical skills and proficiency levels.',
                style: GoogleFonts.lato(
                  fontSize: 14,
                  color: isDark
                ...
                return Dismissible(
                  ...
                  onDismissed: (_) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('Skill removed', style: GoogleFonts.lato()),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        // Warning if no skills available
